...
require('connection.php');
		...
		$found = mysqli_query($conexao,"SELECT * FROM  empresaconhecimento");
			...
			if($modulo == 3){
				if(mysqli_num_rows($found) > 0){
					...
					?>
							...
							<tr><h1>Empregados das empresas :
								...
								<?php while($dados= mysqli_fetch_assoc($found)){
												...
												<tr>
														...
														<td><br><label> <?php echo "<a href='deletar_conhecimento_empresa.php?id=" . $dados['id'] . "'>Apagar</a><br></label></td>";	?>
						...
						?> <h1>Não há empresas cadastradas</h1><br><form action="indexEspecialista.php"><button class="button">Voltar</button></form><?php
				}		
			}else{
